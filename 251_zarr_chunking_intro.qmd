...
In the following [section](./252_zarr_chunking_strat.qmd) , we will go over **optimal chunking strategies** and relevant **considerations** when aiming for making Earth Observation workflows more **efficient**.