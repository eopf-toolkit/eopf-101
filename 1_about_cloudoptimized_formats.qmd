...
The increasing volume of Earth Observation (EO) data presents significant challenges for traditional data processing workflows.<br>
This chapter aims to explore the crucial application of cloud-optimised geospatial formats, how they overcome the limitations of traditional methods by minimising data latency, and how they facilitate efficient access to data subsets within cloud environments.

## By the end of this page, we will be able to...

- ☁️ Understand the principles of cloud-optimised geospatial formats
- 🧊 Have an overview of n-dimensional arrays
- 🗺️ Understand COGs and Zarr structures
