...
This example how to access the 60-metre resolution quicklook of a Sentinel-2 mission, explored in more detail... TODO, requires that the example works in the previous tutorial. But since this works, I think that one should work again too?
