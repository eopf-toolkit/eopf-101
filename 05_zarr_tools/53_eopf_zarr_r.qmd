...
In the following [notebook](./54_eopf_zarr_r_examples.qmd) we will explore more examples such as extracting measurements, as Ocean Wind field and GIFAPAR and how to format, scale, and visualise them on a curvillinear grid 💨.
