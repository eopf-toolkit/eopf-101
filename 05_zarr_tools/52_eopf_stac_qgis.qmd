...
In the following [section](./53_eopf_zarr_r.qmd) we will explore the use of `rstac`, `terra` and `stars` to showcase the calculation of Vegegation Indices with **Sentinel-2 L2A Products** and `R`.