...
In the following [notebook](510_eopf_zarr_julia.ipynb), we will provide a glimpse of how to acces EOPF Zarr data with programming language Julia, how to query the [EOPF STAC Catalog](https://stac.browser.user.eopf.eodc.eu/?.language=en) and visualise results with [CairoMakie](https://docs.makie.org/stable/explanations/backends/cairomakie.html).