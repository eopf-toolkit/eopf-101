...
In this chapter, we will dive into **geospatial cloud-optimised formats** specifically designed for geodata. As data stored in the cloud grows, the way we store and access geographic information needs to evolve. <br>
We will explore why these new formats are important, especially when dealing with large datasets like satellite imagery and other geographical measurements. <br>
This chapter will help understand how these modern approaches are changing the game for working with maps and spatial information.


### What we will learn

- ☁️ What are cloud-optimised formats for geodata.
- 🏛️ Differences between traditional and cloud-native workflows
- 📖 Which are the main characteristics of cloud-optimised formats
- 💾 What are **COGs** and **Zarr**, and how do they help with storing raster data
...
## Conclusion
In this chapter, we explored the fundamental concepts of **cloud-optimised formats for geodata**.<br>
We ecxplored how these new approaches streamline workflows, offering significant advantages over traditional methods, especially when dealing with the vast amounts of information found in geospatial datasets. <br>
By understanding the core characteristics of these formats and by looking at specific examples like **Zarr**, you now have a solid foundation for appreciating how these innovations are making geospatial data more accessible, efficient, and powerful in the cloud.
