...
::: {.callout-note}
Learn more about the EOPF Zarr product structure [here](/02_about_eopf_zarr/21_what_is_zarr.qmd).
:::
...
::: {.callout-note}
EOPF and STAC: Learn more about EOPF and STAC [here](/04_eopf_and_stac/41_stac_intro.qmd).
:::
...
## What's next?
In the following [section](/01_about_eopf/12_about_cloudoptimized_formats.qmd), we learn why EO data needs to be cloud-optimised when processed in the cloud.