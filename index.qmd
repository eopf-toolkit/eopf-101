...
Submit your completed Jupyter Notebook via [GitHub](https://github.com/eopf-toolkit/community-notebook-competition/tree/main/submissions) once complete, between 1 November 2025 and 30 January 2026 (23:59 UTC+1). Clear guidelines, a notebook template and evaluation criteria will be provided in advance via this GitHub repository. We will also provide some challenge prompts to help get you started. Stay tuned!
...
There is also a prize pool of **10 000 Euros** in upskilling vouchers sponsored by [thriveGEO](https://www.thrivegeo.com). In addition, there will be exciting **ESA** swag such as **Sentinel-2 Lego** sets up for grabs!<br>
