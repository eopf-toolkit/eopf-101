...
* **Chapter 4 - Tools to work with EOPF Zarr** -- *more coming soon!*
  * [Access the EOPF Zarr STAC API with R](/05_tools_to_w_w_zarr/51_eopf_stac_r.qmd)
  * [Access the EOPF Zarr STAC API with QGIS](/05_tools_to_w_w_zarr/52_eopf_stac_qgis.qmd)
