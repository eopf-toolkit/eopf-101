...
An R environment is required to follow this tutorial, with R version >= 4.5.0. For local development, we recommend using either [RStudio](https://p!osit.co/download/rstudio-desktop/) or [Positron](https://posit.co/products/ide/positron/) and making use of [RStudio projects](https://support.posit.co/hc/en-us/articles/200526207-Using-RStudio-Projects) for a self-contained coding environment.
...
```{r tci-10m-preview-dims, eval = FALSE}
dim(tci_10m_preview)
```
...
```{r tci-10m-preview-transf, eval = FALSE}
